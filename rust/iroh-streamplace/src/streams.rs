...
impl Node {
    ...
    #[uniffi::constructor]
    pub async fn sender(config: super::Config) -> Result<Arc<Self>, CreateError> {
        super::RUNTIME.block_on(Self::new_in_runtime(config, HandlerMode::Sender))
    }

    #[uniffi::constructor]
    pub async fn forwarder(config: super::Config) -> Result<Arc<Self>, CreateError> {
        super::RUNTIME.block_on(Self::new_in_runtime(config, HandlerMode::Forwarder))
    }
    ...
    pub async fn receiver(
        ...
        super::RUNTIME.block_on(Self::new_in_runtime(config, HandlerMode::receiver(handler)))
    }
