...
// schema: place.stream.server.updateWebhook
...
func ServerUpdateWebhook(ctx context.Context, c util.LexClient, input *ServerUpdateWebhook_Input) (*ServerUpdateWebhook_Output, error) {
	var out ServerUpdateWebhook_Output
	if err := c.LexDo(ctx, util.Procedure, "application/json", "place.stream.server.updateWebhook", nil, input, &out); err != nil {
		return nil, err
	}
