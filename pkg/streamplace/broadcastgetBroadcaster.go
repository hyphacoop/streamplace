...
// schema: place.stream.broadcast.getBroadcaster
...
func BroadcastGetBroadcaster(ctx context.Context, c util.LexClient) (*BroadcastGetBroadcaster_Output, error) {
	var out BroadcastGetBroadcaster_Output

	params := map[string]interface{}{}
	if err := c.LexDo(ctx, util.Query, "", "place.stream.broadcast.getBroadcaster", params, nil, &out); err != nil {
		return nil, err
	}
